      ...
      <div style={{ padding: '36px 32px', background: '#eef2f8' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            {artistes.map(a => (
              <div key={a.id} onClick={() => navigate(`/artiste/${a.id}`)} style={{ background: 'white', borderRadius: '10px', border: '1px solid #c8d8f0', padding: '16px', textAlign: 'center', cursor: 'pointer' }}>
          ...
          <div style={{ background: '#fff8e8', borderRadius: '10px', border: '2px solid #f5c842', padding: '24px', textAlign: 'center' }}>
            ...
            <button onClick={() => navigate('/inscription')} style={{ background: '#e85d2a', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', fontSize: '13px', fontWeight: '500', cursor: 'pointer', width: '100%' }}>Devenir Vendeur</button>
          </div>
        </div>
      </div>
